...
function createData(date, time, title, synopsis, presenter, audience) {
  id += 1;
  return { date, time, title, synopsis, presenter, audience };
}

const rows = [
  createData('2019/01/07', '12:15 ~ 1:00', 'The World', 'The world is beautiful', 'John Doe', 'everyone'),
  createData('2019/01/07', '12:15 ~ 1:00', 'The World', 'The world is beautiful', 'John Doe', 'everyone'),
  createData('2019/01/07', '12:15 ~ 1:00', 'The World', 'The world is beautiful', 'John Doe', 'everyone'),
  createData('2019/01/07', '12:15 ~ 1:00', 'The World', 'The world is beautiful', 'John Doe', 'everyone'),
];

function EventBrowse(props) {
  const { classes } = props;
